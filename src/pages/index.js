...
const IndexPage = () => (
  <Layout>
    ...
    <h1>About Me</h1>
            ...
            <p>To success in my IT Manager role, I have taught myself HTML, CSS, SQL, and Crystal Reports. This led me into discovering software development. I went through the online Full Stack development  program at Flatiron while still working full-time.  Now I am currently  balancing a full-time job while honing in my developer skills in my free time. I am looking for a full-time position in development so I can take this my personal enjoyment and skills in of coding and building things to the next level.</p>
        </div>
    </div> 
  </Layout>
)
